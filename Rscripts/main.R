...
# User Input -----------------------
# Paths
data_path <- "/Users/everestwang/BayesianProject/Data"
object_path <- "/Users/everestwang/BayesianProject/Objects"
output_path <- "/Users/everestwang/BayesianProject/Figures"
# Save
save_figures <- T
# Update
update_sim <- T              
...
#%%
# Run Scripts ----------
source("./Scripts/Rscripts/0 - Functions.R", echo = T)
source("./Scripts/Rscripts/1 - Prepare Data.R", echo = T)
source("./Scripts/Rscripts/2 - Determine Clusters.R", echo = T)
source("./Scripts/Rscripts/3 - Analysis.R", echo = T)
source("./Scripts/Rscripts/4 - Output.R", echo = T)
